...
var simpleGallery_navpanel={
	loadinggif: 'images/Indeximages/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'50px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ 'images/Indeximages/left.gif', 'images/Indeximages/play.gif', 'images/Indeximages/right.gif', 'images/Indeximages/pause.gif'], //nav panel images (in that order)
